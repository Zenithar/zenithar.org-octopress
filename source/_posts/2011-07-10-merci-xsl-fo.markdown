...
Du coup j'ai ajouté à partir du XML de mon CV, 3 cibles au travers de XSL-FO :
  ...
  * CV (FR) : [PDF](http://thibault.n0rmand.org/cv-fr.pdf)

        
  * CV (FR) : [RTF](http://thibault.n0rmand.org/cv-fr.rtf)

        
  * CV (FR) : [DOCX](http://thibault.n0rmand.org/cv-fr.docx)



J'ai essayé de me rapprocher le plus possible du rendu [HResume HTML](http://thibault.n0rmand.org), mais sans les possibilités CSS3 (l'ombre du texte).
